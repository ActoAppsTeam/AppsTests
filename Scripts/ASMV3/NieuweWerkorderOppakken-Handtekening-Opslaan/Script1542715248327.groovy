...
WebUI.click(findTestObject('ASMV3/Order/Resume/Input Objects/button_HandtekeningOpslaan'))

WebUI.delay(3)

WebUI.click(findTestObject('ASMV3/Order/WizardSteps/wizardStep_Details'))

WebUI.delay(3)

WebUI.click(findTestObject('ASMV3/Order/ParkeerWerkorder'))
