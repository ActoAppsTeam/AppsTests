...
WebUI.dragAndDropByOffset(findTestObject('ASMV3/Order/Resume/Input Objects/input_Handtekening'), 0, 600)

WebUI.dragAndDropByOffset(findTestObject('ASMV3/Order/Resume/Input Objects/input_Handtekening'), 600, -200)

WebUI.delay(10)

WebUI.click(findTestObject('ASMV3/Order/Resume/Input Objects/button_HandtekeningGereedMelden'))
